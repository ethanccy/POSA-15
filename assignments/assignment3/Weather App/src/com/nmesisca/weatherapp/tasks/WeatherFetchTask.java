...
import com.nmesisca.weatherapp.activities.MainActivity;
import com.nmesisca.weatherapp.services.WeatherServiceAsync;
import com.nmesisca.weatherapp.services.WeatherServiceSync;
import com.nmesisca.weatherapp.utils.GenericServiceConnection;
...
public class WeatherFetchTask implements RetainedTask
{
	...
	/**
	 * Initialize the non-view fields
	 */
	...
	/**
	 * Stores the weather data, location and 
	 * the last updated time for caching.
	 * 
	 * @author nmesisca
	 *
	 */
